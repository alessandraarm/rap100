CLASS zcl_rap100_gen_data_222 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_222 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '222',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav222.
*    DELETE FROM zrap100_dtrav222.

    "insert travel demo data
    INSERT zrap100_atrav222  FROM (
        SELECT
